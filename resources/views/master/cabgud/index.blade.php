    ...
    <div class="col-xs-12 col-sm-12">
        ...
        <div class="clearfix">
            <div class="col-xs-8 col-sm-8">
                <form method="get" action="{{url('/cabgud')}}">
        ...
        <table id="dynamic-table" class="table table-striped table-bordered table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td align="center">{{$row->wilayahid}}</td>
                    <td align="left">{{$row->wilayahnama}}</td>
                    <td align="center">{{$row->cabangkode}}</td>
                    <td align="left">{{$row->cabangnama}}</td>
                    <td align="center">{{$row->statuscabang==0 ? 'Non Aktif' : 'Aktif'}}</td>
                    <td align="center">{{$row->gudangkode}}</td>
                    <td align="left">{{$row->gudangnama}}</td>
                    <td align="center">{{$row->statusgudang==0 ? 'Non Aktif' : 'Aktif'}}</td>
                </tr>
                @endforeach
            </tbody>
